...
public final class ConstantsConnexion {
	...
	/**
	 * constante contient l'info pour utiliser ou non le mock du NetCatalog.
	 */
	public static final boolean USE_NETCATALOGUE_MOCK = (System.getProperty("netcatalog.useMock") == null || !System
			.getProperty("netcatalog.useMock").trim().equals("true")) ? false : true;

	/**
	 * l'url du service du netCatalogue pour la recuperation du {@link PackagerConfig}.
	 */
	public static final String NETCATALOGUE_SERVICE_URL = "/fiddle/with/catalogue/item?code=";
