package com.nordnet.topaze.businessprocess.packager.swagger;
...
public class SwaggerConfig {
	...
	private static ApiInfo apiInfo() {
		ApiInfo apiInfo =
				new ApiInfo("Business Process Packager API", "Liste des services business-process-packager", null,
						null, null, null);
		return apiInfo;
	}
