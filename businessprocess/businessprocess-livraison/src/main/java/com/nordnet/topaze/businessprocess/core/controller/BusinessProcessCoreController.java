package com.nordnet.topaze.businessprocess.core.controller;
...
public class BusinessProcessCoreController {

	/**
	 * Declaration du log.
	 */
	private static final Logger LOGGER = Logger.getLogger(BusinessProcessCoreController.class);
	...
	/**
	 * Maintenance operationnelle de process InitierBP.
	 * 
	 ...
	 */
	@RequestMapping(value = "/initierBP/{referenceContrat}", method = RequestMethod.POST, headers = "Accept=application/json")
	@ResponseBody
	public void forceProcessInitierBP(final @PathVariable String referenceContrat) throws TopazeException {
		LOGGER.info(":::wsprocess-rec:::forceProcessInitierBP");
