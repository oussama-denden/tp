...
public class NetCustomerMock implements NetCustomer {
	...
	public Handle getHandleByKey(String handleKey) throws CustomerException {
		...
		JAXBElement<String> address1Element = new JAXBElement<>(new QName("address1"), String.class, "john_address1");
		handle.setAddress1(address1Element);
		JAXBElement<String> address2Element = new JAXBElement<>(new QName("address2"), String.class, "john_address2");
		handle.setAddress2(address2Element);
		JAXBElement<String> cityElement = new JAXBElement<>(new QName("city"), String.class, "c1");
		handle.setCity(cityElement);
		JAXBElement<String> companyElement = new JAXBElement<>(new QName("company"), String.class, "john_company");
		handle.setCompany(companyElement);
		JAXBElement<String> countryElement = new JAXBElement<>(new QName("country"), String.class, "john_country");
		handle.setCountry(countryElement);
		JAXBElement<String> firstNameElement = new JAXBElement<>(new QName("firstName"), String.class, "john");
		handle.setFirstName(firstNameElement);
		JAXBElement<String> emailElement = new JAXBElement<>(new QName("email"), String.class, "john@doe.com");
		handle.setEmail(emailElement);
		JAXBElement<String> phoneElement = new JAXBElement<>(new QName("phone"), String.class, "123456789");
		handle.setPhone(phoneElement);
		JAXBElement<String> nameElement = new JAXBElement<>(new QName("name"), String.class, "doe");
		...
		JAXBElement<String> profileTypeElement =
				new JAXBElement<>(new QName("profileType"), String.class, "john_profile");
		handle.setProfileType(profileTypeElement);
		JAXBElement<String> civilityElement = new JAXBElement<>(new QName("civility"), String.class, "M.");
