...
public class InitEnveronement implements ServletContextListener {
	...
	public void contextInitialized(final ServletContextEvent event) {
		...
		final String props = new File(System.getProperty("catalina.base")) + Constants.ENVIRONEMENT;
		...
		if (System.getProperty("cronFacture") == null) {
			System.setProperty("cronFacture", "0 0 0 * * ?");
