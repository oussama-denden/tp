...
import com.nordnet.topaze.client.rest.business.util.DateDeserialiser;
...
public class ContratBillingInfo {
	...
	/**
	 * retourner tous les reductions associe (global, partiel).
	 * 
	 * @return liste {@link ReductionInfo}.
	 */
	public List<ReductionInfo> getToutReductions() {
		List<ReductionInfo> reductions = new ArrayList<>();
		reductions.addAll(reductionContrats);
		if (reductionEC != null) {
			reductions.add(reductionEC);
		}
		return reductions;
	}
	...
	/**
	 * 
	 * @return {@link #typeProduit} Type de Produit BIEN ou SERVICE.
	 */
	 ...
	 * 
	 * @param typeProduit
	 *            link {@link #typeProduit} Type de Produit BIEN ou SERVICE.
	 */
	...
	public boolean isRumRequired() {
		return modePaiement.equals(ModePaiement.SEPA) || modePaiement.equals(ModePaiement.FACTURE)
				|| modePaiement.equals(ModePaiement.FACTURE_FIN_DE_MOIS)
				|| (isRecurrent() && modePaiement.equals(ModePaiement.CB));
	}
	...
	public String getOffre() {
		...
		return contratBillingInfoParent.getOffre();
	}
