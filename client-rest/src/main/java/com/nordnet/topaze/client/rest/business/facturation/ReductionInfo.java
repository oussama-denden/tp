...
import com.nordnet.topaze.client.rest.enums.TypeValeurReduction;
 ...
 * 
 */
public class ReductionInfo implements Comparable<ReductionInfo> {
	...
	@Override
	public int compareTo(ReductionInfo reductionInfo) {
		if (ordre == null && reductionInfo == null) {
			return 0;
		} else if (ordre == null) {
			return -1;
		} else if (reductionInfo.getOrdre() == null) {
			return 1;
		} else {
			return ordre - reductionInfo.getOrdre();
		}
	}
