package com.nordnet.topaze.livraison.outil.util;
...
import com.nordnet.topaze.livraison.outil.spring.ApplicationContextHolder;
...
public class PropertiesUtil {
	...
	/**
	 * Net Customer properties.
	 */
	private Properties netCustomerProperties = ApplicationContextHolder.getBean("netCustomerProperties");
	...
	/**
	 * @return {@link #netCustomerProperties}.
	 */
	public Properties getNetCustomerProperties() {
		return netCustomerProperties;
	}
