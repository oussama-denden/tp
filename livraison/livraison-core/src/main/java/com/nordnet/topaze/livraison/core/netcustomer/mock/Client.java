...
public class Client {
	...
	public void setDefaultHandle(Handle defaultHandle) {
	...
	public void setGodFatherKey(String godFatherKey) {
		this.godFatherKey = godFatherKey;
	}

	public List<String> getHandleKeys() {
		return handleKeys;
	}

	public void setHandleKeys(List<String> handleKeys) {
	...
	public Boolean getIsMarguerite() {
		return isMarguerite;
	}

	public void setIsMarguerite(Boolean isMarguerite) {
