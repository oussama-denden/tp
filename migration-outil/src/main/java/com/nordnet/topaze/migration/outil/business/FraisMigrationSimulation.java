...
import com.nordnet.topaze.migration.outil.enums.TypeFraisDeserializer;
import com.nordnet.topaze.migration.outil.util.Utils;

/**
 * Cette classe regroupe les informations qui definissent un {@link FraisMigrationSimulation}.
 * 
 * @author anisselmane.
 * 
 */
public class FraisMigrationSimulation implements Comparable<FraisMigrationSimulation> {
	 ...
	 */
	public FraisMigrationSimulation() {
	...
	@Override
	public int compareTo(FraisMigrationSimulation frais) {
