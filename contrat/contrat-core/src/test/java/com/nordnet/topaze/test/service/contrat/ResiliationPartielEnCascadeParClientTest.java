 ...
 * 
 */
public class ResiliationPartielEnCascadeParClientTest extends GlobalTestCase {

	/**
	 * The log of the class.
	 */
	private static final Log LOGGER = LogFactory.getLog(ResiliationPartielEnCascadeParClientTest.class);
	...
	public void testResiliationPartielEnCascadeParClientTestValid() {
		try {
