 ...
 * 
 */
public class ResiliationPartielParNordNetTest extends GlobalTestCase {

	/**
	 * The log of the class.
	 */
	private static final Log LOGGER = LogFactory.getLog(ResiliationPartielParNordNetTest.class);
