...
import com.nordnet.topaze.contrat.util.TypePrixDeserializer;

/**
 * Enumeration que d�finit  le type de prix de  {@link DetailProduit}.
 * <p>deux types Prix:</p>
 * <ul>
 ...
 * <li>Trois fois sans frais : c'est une sorte de mix des 2 pr�c�dents.</li>
 * </ul>
 * 
...
public enum TypePrix {
	...
	/**
	 * Cette methode sera utiliser par le {@link TypePrixDeserializer} pour faire la d�s�rialisation.
	 * 
	 * @param typePrix on retourne null si la valeur de string n'est pas ONE_SHOT ou RECURRENT.
