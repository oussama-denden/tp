...
public class ResiliationBillingInfo {
	...
	/**
	 * Reductions sur le contrat gobal.
	 */
	...
	/**
	 * ajout de reduction contrat.
	 * 
	 * @param reductionContrat
	 *            {@link ReductionInfo}.
	 */
	public void addReductionInfoContrat(ReductionInfo reductionContrat) {
		this.reductionInfoContrats.add(reductionContrat);
	}
