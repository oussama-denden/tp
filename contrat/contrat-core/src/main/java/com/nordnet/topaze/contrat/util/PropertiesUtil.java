...
public class PropertiesUtil {
	 ...
	 */
	private final Properties topazeExceptionsProperties = ApplicationContextHolder
			.getBean("topazeExceptionsProperties");

	/**
	 * Dynamic properties file.
	 */
	final MessageSource dynamicProperties = ApplicationContextHolder.getBean("dynamicProperties");
	...
	public LocalDateTime getDateDuJour() throws TopazeException {
		String dateDuJourString =
				dynamicProperties.getMessage(Constants.DATE_DU_JOUR_PROPERTY, null,
						Constants.DEFAULT_DATE_WITHOUT_TIME_FORMAT.format(new Date()), null);
	 ...
	 *             {@link TopazeException}.
	 */
	public LocalDateTime getDateDuJourWithTime() throws TopazeException {
		String dateDuJourString =
				dynamicProperties.getMessage(Constants.DATE_DU_JOUR_PROPERTY, null,
						Constants.DEFAULT_DATE_WITHOUT_TIME_FORMAT.format(new Date()), null);
		if (Utils.isStringNullOrEmpty(dateDuJourString) || dateDuJourString.equals(Constants.NOW)
