...
public class PrixMigration {
	 ...
	 * liste des frais.
	 */
	private Set<FraisMigration> frais = new HashSet<>();
	 ...
	 * @return the frais
	 */
	public Set<FraisMigration> getFrais() {
		return frais;
	}
	 ...
	 *            the new frais
	 */
	public void setFrais(Set<FraisMigration> frais) {
		this.frais = frais;
	}
	 ...
	 * @return the prix
	 */
	public Prix toPrix(ModePaiement modePaiement) {
		Prix prix = new Prix();
		...
		for (FraisMigration fraisMigration : this.frais) {
			frais.add(fraisMigration.toFrais());
		}
