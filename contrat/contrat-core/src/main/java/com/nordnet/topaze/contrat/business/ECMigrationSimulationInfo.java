...
public class ECMigrationSimulationInfo {
	...
	/**
	 * Reductions sur le contrat global.
	 */
	...
	public String toString() {
		return "ECResiliationInfo [referenceProduit=" + referenceProduit;
	}
	 ...
	 */
	public void setReductionInfoContrat(List<ReductionInfo> reductionInfoContrats) {
		this.reductionInfoContrats = reductionInfoContrats;
	}

	/**
	 * Ajout d'une reduction sur contrat.
	 * 
	 * @param reductionInfo
	 *            {@link ReductionInfo}.
	 */
	public void addReductionInfoContrat(ReductionInfo reductionInfo) {
		this.reductionInfoContrats.add(reductionInfo);
	}
