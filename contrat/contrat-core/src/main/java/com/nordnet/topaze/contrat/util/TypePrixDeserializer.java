 ...
 * Cette classe sera utiliser notamment par les controlleur pour l'auto-population de {@link Produit} � partir des parametres de requ�te HttpServletRequest.
 * 
 * @author Denden-OUSSAMA
 *
 */
public class TypePrixDeserializer extends
		JsonDeserializer<TypePrix> {

	@Override
	public TypePrix deserialize(JsonParser parser,
